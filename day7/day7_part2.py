...
def find_hand_type(card_counts):
    ...
    J is the Joker card and can be used as any card. The hand type for the cards will be the best possible hand type using the Joker card.
    ...
    if 4 in card_counts.values():
        if card_counts['J'] == 1 or card_counts['J'] == 4:
            return 'Five of a kind'
